...
class BluetoothController extends GetxController {
  ...
  //         _processBuffer(onComplete: () {
  //           log("Buffer sudah diproses semua");
  //           isDone.value = true;
  //         });
  //       });
  //     });
  ...
  //   }
  //   // kalau sudah keluar loop, panggil callback
  //   if (onComplete != null) onComplete();
  // }

  // Future<void> addAdmin(String arg, String auth) async {
  //   isDone.value = false;
  //   WidgetsBinding.instance.addPostFrameCallback((_) {
  //     Get.dialog(
  //       Dialog(
  ...
  //       connection!.output.add(Uint8List.fromList(data.codeUnits));
  //       await connection!.output.allSent;
  //       // tunggu sampai buffer selesai (isDone = true)
  ...
  // Future<void> resetFactory(String arg) async {
  //   isDone.value = false;
  //   WidgetsBinding.instance.addPostFrameCallback((_) {
  //     Get.dialog(
  //       Dialog(
  ...
  //   //! Function
  //   String data = "n\n?\n$arg";
  //   log("Reset Factory Finger Print!");
  //   try {
  //     if (connection != null && connection!.isConnected) {
  //       connection!.output.add(Uint8List.fromList(data.codeUnits));
  //       await connection!.output.allSent;
  ...
  //               CircularProgressIndicator(),
  //               SizedBox(height: 24.h),
  //               Text("Menerima data dari fingerprint!.")
  //             ],
  //           ),
  //         ),
  //       ),
  ...
  //   await inquiryTemplate(args);

  //   // try {
  //   //   String data = "7\n?\n$args";
  //   //   log("Mengirim Perintah: $data");
  //   //   if (connection != null && connection!.isConnected) {
  //   //     connection!.output.add(Uint8List.fromList(data.codeUnits));
  //   //     await connection!.output.allSent;
  //   //   }
  ...
  // Future<void> inquiryTemplate(String args) async {
  //   try {
  //     //! String Sent!
  //     String data = "7\n?\n$args";
