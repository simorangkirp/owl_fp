...
import 'package:owl_fp_newer/data/dal/daos/fingerprint/fp.repoimpl.dart';
...
class Bt14CtrlBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(
        () => RegisterFingerUseCase(Get.find<BluetoothRepositoryImpl>()));
    Get.lazyPut(
        () => GetPairedDevicesUseCase(Get.find<BluetoothRepositoryImpl>()));
    Get.lazyPut(() => GetMasterAdminUsecase(Get.find<FingerprintRepoImpl>()));
    Get.lazyPut(
        () => FetchInitValueUseCase(Get.find<BluetoothRepositoryImpl>()));
    ...
    Get.lazyPut<Bt14CtrlController>(
      () => Bt14CtrlController(
        ...
        Get.find<RegisterFingerUseCase>(),
        Get.find<FetchInitValueUseCase>(),
      ),
    );
  }
}
